...
export CURA_VERSION_MAJOR="${CURA_VERSION_MAJOR:-4}"
export CURA_VERSION_MINOR="${CURA_VERSION_MINOR:-1}"
export CURA_VERSION_PATCH="${CURA_VERSION_PATCH:-99}"
export CURA_VERSION_EXTRA="${CURA_VERSION_EXTRA:-SLM}"
export CURA_BUILD_NAME="${CURA_BUILD_NAME:-SLM}"

export CURA_SDK_VERSION="${CURA_SDK_VERSION:-6.0.0}"
